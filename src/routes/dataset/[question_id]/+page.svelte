...
<div class="max-w-xl mx-auto mt-10 overflow-hidden bg-white shadow sm:rounded-lg">
	<div class="px-4 py-5 sm:p-6">
		<form action="#" class="relative">
			<div
				class="overflow-hidden rounded-lg border border-gray-300 shadow-sm focus-within:border-amber-500 focus-within:ring-1 focus-within:ring-amber-500"
			>
				...
				<textarea
					...
					name="answer"
					id="answer"
					bind:value={data.question.answer}
			...
			<div class="absolute inset-x-px bottom-0">
				<div
					class="flex items-center justify-center space-x-3 border-t border-gray-200 px-2 py-2 sm:px-3"
				>
