    ...
    <div class="px-4 py-5 sm:p-6">
        <form action="#" class="relative">
            <div class="overflow-hidden rounded-lg border border-gray-300 shadow-sm focus-within:border-amber-500 focus-within:ring-1 focus-within:ring-amber-500">
              ...
              <input type="text" bind:value={data.question.question} name="question" id="question" class="block w-full border-0 pt-2.5 text-lg font-medium placeholder:text-gray-400 focus:ring-0" placeholder="Question" autofocus>
              <label for="answer" class="sr-only">Answer</label>
              <textarea rows="2" name="answer" id="answer" bind:value={data.question.answer} class="block w-full resize-none border-0 py-0 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="Your Answer..."></textarea>
