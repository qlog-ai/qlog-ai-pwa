...
<div class="bg-white shadow-md">
	<div
		class="mx-auto max-w-8xl divide-y divide-gray-900/10 px-6 py-6 sm:py-32 lg:px-8 lg:py-10 mt-4"
	>
		...
		{#each data.questions as question}
			<dl class="mt-4 space-y-4 divide-y divide-gray-900/10">
				<div class="pt-4 lg:grid lg:grid-cols-12 lg:gap-2">
					<dt class="text-base font-semibold leading-7 text-gray-900 lg:col-span-4">
						{question.question}
					</dt>
					...
					<div class="lg:col-span-2 flex justify-end items-center space-x-2">
						<button
							on:click={() => goto(`/dataset/${question.id}`)}
