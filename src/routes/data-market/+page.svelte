...
<ul role="list" class="mt-4 grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
		...
		>
			<div class="flex flex-1 flex-col p-8">
				...
				<dl class="mt-1 flex flex-grow flex-col justify-between">
					...
					<dd class="text-sm text-gray-500">500 Solidity Questions Dataset</dd>
				</dl>
			</div>
			<div>
	...
	>
		<div class="flex flex-1 flex-col p-8">
			<img
				class="mx-auto h-32 w-32 flex-shrink-0 rounded-full"
				src="/chris_lattner.jpeg"
				alt=""
			/>
			<h3 class="mt-6 text-sm font-medium text-gray-900">Chris Lattner</h3>
			<dl class="mt-1 flex flex-grow flex-col justify-between">
				<dt class="sr-only">Title</dt>
				<dd class="text-sm text-gray-500">CEO Modular AI</dd>
				<dt class="sr-only">Role</dt>
				<dd class="text-sm text-gray-500">500 Compiler design Questions Dataset</dd>
			</dl>
		</div>
		<div>
			<div class="-mt-px flex divide-x divide-gray-200">
	...
	>
		<div class="flex flex-1 flex-col p-8">
			<img
				...
				alt=""
			/>
			<h3 class="mt-6 text-sm font-medium text-gray-900">Vitalik Buterin</h3>
			<dl class="mt-1 flex flex-grow flex-col justify-between">
				<dt class="sr-only">Title</dt>
				<dd class="text-sm text-gray-500">Eth grandfather</dd>
				<dt class="sr-only">Role</dt>
				<dd class="text-sm text-gray-500">500 Ethereum Questions Dataset</dd>
			</dl>
		</div>
		<div>
			<div class="-mt-px flex divide-x divide-gray-200">
	...
	>
		<div class="flex flex-1 flex-col p-8">
			<img
				...
				alt=""
			/>
			<h3 class="mt-6 text-sm font-medium text-gray-900">Linus Torvalds</h3>
			<dl class="mt-1 flex flex-grow flex-col justify-between">
				<dt class="sr-only">Title</dt>
				<dd class="text-sm text-gray-500">Linux creator</dd>
				<dt class="sr-only">Role</dt>
				<dd class="text-sm text-gray-500">500 Kernel design Questions Dataset</dd>
			</dl>
		</div>
		<div>
			<div class="-mt-px flex divide-x divide-gray-200">
